...
<style>
    ...
    /* Rótulos de destaque e títulos */
    .label-vermelho { color: #004F54; font-weight: bold; }
    .titulo-custom { color: #004F54; font-weight: bold; font-size: 1.5rem; }
    
    /* Badges/Tags para Tema, Subtema e Classificação */
    .badge-verde {
    ...
    /* Caixa de texto do resumo gerado pela IA */
    .resumo-box { 
...
# Logo na barra lateral (Logo Oficial do MPRJ)
...
# Definindo o nome do arquivo da logo do CAO Cidadania
NOME_IMAGEM = "CAO CIDADANIA - LOGO 1.png"
diretorio_atual = os.path.dirname(__file__)

# Lógica de verificação e fallback da extensão da imagem
...
# Exibição do logo e título ajustados no contêiner
with col_logo:
